# Generated by Django 4.0.1 on 2022-01-25 04:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.ImageField(blank=True, null=True, upload_to='posts/%Y/%m/%d', verbose_name='Imagen post')),
                ...
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foro.categorias')),
            ],
        ),
    ]
